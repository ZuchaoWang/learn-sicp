...
class RegInst:
    ...
    should_break indicates whether this is a breakpoint
    it must be a seperate field, it cannot be the return value of exec
    because if should_break, we should break before execution
    this is useful in debugging
    '''

    def __init__(self, code: InstMstmt):
        self.code = code
        self.raw_exec: Callable = lambda: None
        self.exec: Callable = lambda: None
        self.should_break: Callable[...,bool] = lambda: False
